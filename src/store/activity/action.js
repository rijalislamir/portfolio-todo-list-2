    ...
    async (_, thunkAPI) => {
        try {
            ...
            const response = await axios.get(
                `${process.env.VITE_BASE_API}/api/activities`,
...
export const getActivityDetail = createAsyncThunk(
    ...
    async ({ id }, thunkAPI) => {
        try {
            const response = await axios.get(`${process.env.VITE_BASE_API}/api/activities/${id}`)
    ...
    async (body, thunkAPI) => {
        try {
            ...
            const response = await axios.put(
                `${process.env.VITE_BASE_API}/api/activities/${body.id}`,
                body,
                { headers: { Authorization: `Bearer ${token}` }}
            )
    ...
    async ({ id }, thunkAPI) => {
        try {
            ...
            const response = await axios.delete(
                `${process.env.VITE_BASE_API}/api/activities/${id}`,
                { headers: { Authorization: `Bearer ${token}` }}
            )
